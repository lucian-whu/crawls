    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try {
            for (i = 224; i <= 500; i++) {
                ...
                String url = "http://apps.webofknowledge.com/summary.do?product=WOS&parentProduct=WOS&search_mode=GeneralSearch&qid=3&SID=Q2MPj5GBH11pRyE37b5&colName=WOS&page="+i+"&action=changePageSize&pageSize=50";
                ...
                for (j = 1;j < 51;j++) {
                    ...
                    FileWriter fw=new FileWriter(new File("/home/xiaoxianglong/articles_gapsWos/"+((i-1)*50+j)+".html"));
