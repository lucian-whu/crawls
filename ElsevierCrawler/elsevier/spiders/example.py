...
class ArticleSpider(CrawlSpider):
    ...
    rules = (
        Rule(LinkExtractor(allow=(), restrict_xpaths=('//div[@id="volumeIssueData"]/ol/li',), ), callback="parse_item",
             follow=True, ),
    ...
    def parse_item_2(self, response):
        ...
        with open("G:\\journals\\informetrics\\" + name + ".html", 'w', encoding='utf-8') as file:
            file.write(html)
